...
// eststo: ivreghdfe accident_occurred mean_temperature mean_precipitation population (mean_pm25 = inversion_coverage), absorb(fips weekday) cluster(fips) first
// eststo: ivreghdfe accident_occurred mean_temperature mean_precipitation population (mean_pm25 = inversion_coverage), absorb(fips weekday month) cluster(fips) first
//
...
eststo: ivreghdfe accident_occurred mean_temperature mean_precipitation population (mean_pm25 = *_lapse pbl_height), absorb(fips weekday) cluster(fips) first
eststo: ivreghdfe accident_occurred mean_temperature mean_precipitation population (mean_pm25 = *_lapse pbl_height), absorb(fips weekday month) cluster(fips) first
...
eststo: ivreghdfe accident_occurred heat_degree_days cool_degree_days mean_precipitation population (mean_pm25 = *_lapse pbl_height), absorb(fips weekday) cluster(fips) first
eststo: ivreghdfe accident_occurred heat_degree_days cool_degree_days mean_precipitation population (mean_pm25 = *_lapse pbl_height), absorb(fips weekday month) cluster(fips) first
