...
eststo: ivprobit accident_occurred heat_degree_days cool_degree_days mean_precipitation employment i.weekday (mean_pm25 = meanlayer* pbl_height), vce(cluster fips) first
