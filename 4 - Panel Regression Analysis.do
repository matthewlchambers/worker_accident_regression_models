...
* Start logging
log using Construction_accident_analysis_log.log, replace name(main)
...
xtivreg accident_occurred mean_temperature mean_precipitation employment i.weekday (mean_pm25 mean_pm25_2 mean_pm25_3 = inversion_coverage inversion_coverage_2 inversion_coverage_3), fe
